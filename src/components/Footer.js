...
const Footer = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const newScale = distanceFromBottom < 200
        ? 1 + (1 - distanceFromBottom / 200) * 0.25
        : 1;
    ...
    <div id="footer">
      ...
      <div className="social-links">
        <a href="https://www.linkedin.com/in/naveenchandar/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" title="LinkedIn Profile">
          <svg className="social-icon" style={{ transform: `scale(${scale})` }} height="72" width="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M8,72 L64,72 C68.418278,72 72,68.418278 72,64 L72,8 C72,3.581722 68.418278,-8.11624501e-16 64,0 L8,0 C3.581722,8.11624501e-16 -5.41083001e-16,3.581722 0,8 L0,64 C5.41083001e-16,68.418278 3.581722,72 8,72 Z" fill="currentColor" /><path d="M62,62 L51.315625,62 L51.315625,43.8021149 C51.315625,38.8127542 49.4197917,36.0245323 45.4707031,36.0245323 C41.1746094,36.0245323 38.9300781,38.9261103 38.9300781,43.8021149 L38.9300781,62 L28.6333333,62 L28.6333333,27.3333333 L38.9300781,27.3333333 L38.9300781,32.0029283 C38.9300781,32.0029283 42.0260417,26.2742151 49.3825521,26.2742151 C56.7356771,26.2742151 62,30.7644705 62,40.051212 L62,62 Z M16.349349,22.7940133 C12.8420573,22.7940133 10,19.9296567 10,16.3970067 C10,12.8643566 12.8420573,10 16.349349,10 C19.8566406,10 22.6970052,12.8643566 22.6970052,16.3970067 C22.6970052,19.9296567 19.8566406,22.7940133 16.349349,22.7940133 Z M11.0325521,62 L21.769401,62 L21.769401,27.3333333 L11.0325521,27.3333333 L11.0325521,62 Z" fill="#FFF" /></g></svg>
        </a>

        <a href="https://github.com/navchandar/" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile" title="GitHub Profile">
          <svg className="social-icon" style={{ transform: `scale(${scale})` }} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="https://stackoverflow.com/users/7964299/naveen?tab=profile/" target="_blank" rel="noopener noreferrer" aria-label="Stack Overflow Profile" title="Stack Overflow Profile">
          <svg className="social-icon" style={{ transform: `scale(${scale})` }} xmlns="http://www.w3.org/2000/svg" width="512" height="512" fill="currentColor" viewBox="0 0 512 512"><path d="M392,440V320h40V480H64V320h40V440Z" /><path d="M149.1,308.77l198.57,40.87,8.4-39.32L157.5,269.45Zm26.27-93.12L359.22,300,376,263.76,192.18,178.92Zm50.95-89,156,127.78,25.74-30.52-156-127.78ZM328,32,294.61,55.8,415.43,216.17,448,192ZM144,400H348V360H144Z" /></svg>
        </a>
        ...
        <a href="https://www.credly.com/users/naveenchandar/badges/" target="_blank" rel="noopener noreferrer" aria-label="Credly Badges" title="Credly Badges">
          <svg class="social-icon" style={{ transform: `scale(${scale})` }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.0 16.0" preserveAspectRatio="xMidYMid meet">
        ...
        <a href="https://skillsoft.digitalbadges.skillsoft.com/profile/naveenchandar/wallet/" target="_blank" rel="noopener noreferrer" aria-label="Skillsoft Badges" title="Skillsoft Badges">
          <svg class="social-icon" style={{ transform: `scale(${scale})` }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32.0 32.0" preserveAspectRatio="xMidYMid meet">
